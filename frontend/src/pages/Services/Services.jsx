...
import { FaTractor, FaSeedling, FaLeaf, FaWater, FaTree, FaUserGraduate } from 'react-icons/fa';
import { IoMdArrowDropright } from 'react-icons/io';

const services = [
  {
    title: 'Soil Testing and Analysis',
    description: 'Get comprehensive insights into the nutrient composition and quality of your soil.',
    icon: <FaSeedling />,
  ...
  },
  {
    ...
    description: 'Expert guidance on crop selection and farming strategies for maximum yield.',
    icon: <FaLeaf />,
  ...
  },
  {
    ...
    description: 'Affordable and reliable farm equipment rentals with full maintenance support.',
    icon: <FaTractor />,
  ...
  },
  {
    ...
    description: 'Efficient irrigation solutions to optimize water usage and crop growth.',
    icon: <FaWater />,
  ...
  },
  {
    ...
    description: 'Integrating trees into farming for biodiversity and sustainability.',
    icon: <FaTree />,
  ...
  },
  {
    ...
    description: 'Comprehensive training on modern and sustainable agricultural practices.',
    icon: <FaUserGraduate />,
    ...
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <header className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
          We are dedicated to providing a comprehensive range of services to support farmers and promote sustainable agricultural practices. Discover how we can help you optimize your farming operations and achieve success.
        </p>
      </header>
          ...
          >
            ...
            <details className="text-gray-700 cursor-pointer">
              <summary className="flex items-center">
                <span className="text-green-600 hover:text-green-800 transition-colors duration-1000">Read more</span>
        ...
        <div className="flex justify-center">
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-1000 transform hover:scale-105">
              <p className="text-gray-700 italic">"The soil testing service was a game-changer for our farm. We were able to improve our soil health significantly and saw a substantial increase in our crop yields."</p>
              <p className="text-right mt-4 text-gray-900 font-semibold">- Farmer John</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-1000 transform hover:scale-105">
              <p className="text-gray-700 italic">"The crop consultation helped us choose the best crops for our climate and market. Their expert advice and support have been invaluable."</p>
              <p className="text-right mt-4 text-gray-900 font-semibold">- Farmer Lisa</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-16 text-center">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Contact us today to learn more about our services and how we can help you achieve your farming goals. Our team of experts is here to support you every step of the way.</p>
        <a href="/contact" className="inline-block bg-green-600 text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-green-700 transition-colors duration-1000">Contact Us</a>
      </section>
    </div>
  );
};
