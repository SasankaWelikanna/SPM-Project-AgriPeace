                  ...
                  <tbody>
                     {
                        users.map((user, idx) => <tr
                           ...
                           className='border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600'>
                              ...
                              <td className='whitespace-nowrap px-6 py-4'>
                                 <span onClick={() => handleDelete(user._id)} className='inline-flex items-center gap-2 cursor-pointer bg-red-600 py-1 rounded-md px-2 text-white'>Delete <MdDelete className='text-white' /></span>
                              </td>
                           </tr>)
                     }
                  </tbody>
